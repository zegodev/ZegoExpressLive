...
export declare class ZegoSignal {
    ...
    private updateToken;
    sendMessageWithCallback(cmd: string, seq: number, sessionId: number, body: any, success?: Function | null, error?: Function | null): void;
    private getHeader;
    connectServer(token: string, serverUrl: string, result?: Function): void;
    private startConnectTimer;
    disconnectServer(): void;
    isServerConnected(): boolean;
    createSession(seq: number, type: number, mode: number, streamId: string, strAuthParam: string | undefined, success: Function, error: Function): void;
    ...
    addSession(sessionId: string, token: string): void;
    ...
    sendCandidateInfo(seq: number, sessionId: number, candidateList: Array<any>, success: Function, error: Function): void;
    sendMediaDescAck(seq: number, sessionId: number, result: any): void;
    sendCandidateInfoAck(seq: number, sessionId: number, result: any): void;
    sendCloseSessionAck(seq: number, sessionId: number, result: any): void;
    sendResetSessionAck(seq: number, sessionId: number, result: any): void;
    registerPushCallback(cmd: string, sessionId: number, callback: Function): void;
    unregisterPushCallback(cmd: any, sessionId: number): void;
