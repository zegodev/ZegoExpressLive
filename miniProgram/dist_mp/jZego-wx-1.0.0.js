...
var BaseCenter = /** @class */ (function (_super) {
    ...
    BaseCenter.prototype.logout = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.roomHandler.logout(resolve, reject);
        });
    };
    ...
    BaseCenter.prototype.publishTarget = function (cdnPushConfig) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.streamHandler.publishTarget(cdnPushConfig, resolve, reject);
        });
    };
...
var RoomHandler = /** @class */ (function () {
     ...
     */
    RoomHandler.prototype.logout = function (success, error) {
        this.logger.debug('zb.rh.lo call');
        if (this.stateCenter.runState === zego_entity_1.ENUM_RUN_STATE.logout) {
            this.logger.warn('zb.rh.lo at logout');
            error(zego_error_1.commonErrorList.NOT_LOGIN);
            return;
        }
        this.resetRoom();
...
var StreamHandler = /** @class */ (function () {
    ...
    StreamHandler.prototype.updateMixStream = function (mixStreamConfig, successCallback, errorCallback) {
        ...
        if (!mixStreamConfig.taskId) {
            ...
            errorCallback(zego_error_1.commonErrorList.PARAM);
            return false;
        }
        ...
        if (!mixStreamConfig.outputList || mixStreamConfig.outputList.length == 0) {
            ...
            errorCallback(zego_error_1.commonErrorList.MIX_OUTPUT);
            return false;
        }
        var req_body = {
        ...
        if (mixStreamConfig.advance && mixStreamConfig.advance.videoCodec) {
            if (mixStreamConfig.advance.videoCodec !== 'h264' && mixStreamConfig.advance.videoCodec !== 'vp8') {
                ...
                errorCallback(zego_error_1.commonErrorList.MIX_VIDEOC);
                return false;
            }
        ...
        mixStreamConfig.outputList.forEach(function (streamInfo) {
            ...
            if (mixStreamConfig.advance) {
                if (streamInfo.outputAudioConfig) {
                    outputStreamInfo['audio_enc_id'] = streamInfo.outputAudioConfig;
                }
                else if (isVP8) {
        ...
        if (mixStreamConfig.advance) {
            ...
            if (mixStreamConfig.advance.waterMark) {
                req_body['watermark'] = mixStreamConfig.advance.waterMark;
            }
            if (mixStreamConfig.advance.extraParams) {
                req_body['extra_params'].push.apply(req_body['extra_params'], mixStreamConfig.advance.extraParams);
            }
        }
...
var ZegoClient = /** @class */ (function (_super) {
    ...
    ZegoClient.isSupportLive = function () {
        return new Promise(function (resolve, reject) {
